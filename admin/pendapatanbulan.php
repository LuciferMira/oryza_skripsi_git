                                    ...
                                    <div class="col-lg-2">
                                        <div class="btn-group">
                                            <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle btn btn-primary btn-block">
                                                <i class="fa fa-usd"></i> Pendapatan</button>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                              <a href="d_barang.php?id=<?=$data['id_barang'];?>" class="badge badge-pending"><i class="fas fa-list"></i>Detail</a>
                                              <a href="e_stok.php?id=<?=$data['id_barang'];?>" class="badge badge-warning"><i class="fas fa-edit"></i>Edit</a>
