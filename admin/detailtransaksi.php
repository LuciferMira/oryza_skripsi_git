...
$id=$_GET['id_pesanan'];
$query =mysqli_query($koneksi, "SELECT * FROM transaksi WHERE id_pesanan='$id'");
...
?>
        ...
        <div class="form-group">
          ...
          <input value="<?php echo $data['id_pesanan'];?>" type="text" name="id_pesanan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">ID PRODUK</label>
          <input value="<?php echo $data['id_barang'];?>" type="text" name="id_barang" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
