<?php require_once("head.php"); ?>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Detail Pengeluaran</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                   <div class="row">
                                    <div class="col-lg-10">
                                        <h4 class="card-title">Detail Penegluaran</h4>
                                    </div>
 ...
 <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input value="<?=$data['nama_barang']?>"type="text" name="nama_barang" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input value="<?=$data['total_pemasukan']?>"type="number" name="total_pemasukan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
        </div>
