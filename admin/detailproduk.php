...
require_once('../config/koneksi.php');
    ...
    ?>
      ...
      <div class="form-group">
          ...
          <input value="<?=$data['berat'].'Kg';?>" type="number" name="berat" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
        </div>
       <div class="form-group">
         ...
         <div class="form-group">
                ...
                <textarea type="text" name="deskripsi" class="form-control" value="<?=$data['deskripsi']?>" readonly></textarea>
              </div>
         <div class="form-group">
                <label for="exampleInputEmail1">Kategori</label>
                <textarea type="text" name="kategori" class="form-control" value="<?=$data['kategori']?>" readonly></textarea>
              </div>
