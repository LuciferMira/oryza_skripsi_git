<?php require_once("head.php"); ?>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Detail Total Penjualan</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                   <div class="row">
                                    <div class="col-lg-10">
                                        <h4 class="card-title">Detail Total Penjualan</h4>
                                    </div>
 ...
 <div class="form-group">
          ...
          <input value="<?=$data['id_pesanan']?>"  type="text" name="pesan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
        </div>
         <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input value="<?=$data['nama_konsumen']?>"  type="text" name="nama_konsumen" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Tanggal Beli</label>
          <input value="<?php echo $data['tanggal_beli']?>" type="date" name="tanggal_beli" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
        </div>
 <div class="form-group">
