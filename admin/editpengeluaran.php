<?php require_once("head.php"); ?>
 ...
 <div class="form-group">
          ...
          <input value="<?=$data['id_barang']?>"  type="text" name="id_barang" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" readonly>
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Tanggal Pengeluaran</label>
          <input value="<?php echo $data['tanggal']?>" type="date" name="tanggal" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Nama Barang</label>
          <input value="<?=$data['nama_barang']?>"type="text" name="nama_barang" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <div class="modal-footer">
            <a href="datapengeluaran.php" class="btn btn-secondary" data-dismiss="modal">Keluar</a>
            <a href="datapengeluaran.php" class="btn btn-primary" data-dismiss="modal">Simpan</a>
          </div>
             </form>     
