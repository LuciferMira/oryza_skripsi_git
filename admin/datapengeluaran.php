                                    ...
                                    <div class="col-lg-2">
                                        <div class="btn-group">
                                            ...
                                            <div tabindex="-1" aria-hidden="true" role="menu" class="dropdown-menu">
                                                <button type="button" tabindex="0" class="dropdown-item"><a href="perbulan.php" class="badge badge-pending">Perbulan</a></button>
                                                <button type="button" tabindex="0" class="dropdown-item"><a href="mingguan.php" class="badge badge-pending">Perminggu</a></button>
                                            </div>
                                        </div>
