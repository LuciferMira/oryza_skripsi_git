<?php require_once("head.php"); 
  ...
  if(isset($_GET['id'])){
  $edit=$_GET['id'];
  $query =mysqli_query($koneksi, " SELECT * from barang_keluar where id='$edit' ");
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Edit Data Keluar</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<div class="form-group">
          ...
          <input value="<? echo $data['nama_barang']?>"  type="text" name="barang" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Kategori</label>
          <input value="<? echo $data['kategori']?>"type="text" name="kategori" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
          <label for="exampleInputEmail1">Tanggal Keluar</label>
          <input value="<?php echo $data['tanggal_keluar']?>" type="date" name="tglklr" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
