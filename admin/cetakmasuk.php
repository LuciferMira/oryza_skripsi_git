...
$pdf->Cell(2, 1, 'Berat', 1, 0, 'C');
$pdf->Cell(3, 1, 'Jumlah', 1, 0, 'C');
$pdf->Cell(3, 1, 'Harga Satuan', 1, 0, 'C');
$pdf->Cell(4, 1, 'Total Harga', 1, 1, 'C');
...
while($lihat=mysqli_fetch_array($query)){
	//26
	$pdf->Cell(1, 1, $no , 1, 0, 'C');
	$pdf->Cell(2, 1, $lihat['id'],1, 0, 'C');
	$pdf->Cell(5, 1, $lihat['nama_barang'],1, 0, 'C');
	$pdf->Cell(4, 1, $lihat['tanggal_masuk'], 1, 0,'C');
	$pdf->Cell(2, 1, $lihat['berat'],1, 0, 'C');
	$pdf->Cell(3, 1, $lihat['jumlah'], 1, 0,'C');
	$pdf->Cell(3, 1, $lihat['harga'], 1, 0,'C');
	$pdf->Cell(4, 1, $lihat['harga'], 1, 1,'C');
