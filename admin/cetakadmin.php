...
$pdf->Cell(25.5,0.7,"Laporan Data Admin",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(3, 1, 'Nama ', 1, 0, 'C');
$pdf->Cell(4, 1, 'Email', 1, 0, 'C');
$pdf->Cell(3, 1, 'Tgl Lahir', 1, 0, 'C');
$pdf->Cell(8, 1, 'Alamat', 1, 0, 'C');
$pdf->Cell(6, 1, 'Telepon', 1, 1, 'C');
