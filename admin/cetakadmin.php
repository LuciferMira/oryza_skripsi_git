...
$tgl = date('d-m-Y');
$query = mysqli_query($koneksi,"SELECT * FROM user WHERE akses='admin' ORDER BY nama_pengguna");
...
$pdf->Cell(0,0,'Laporan Data Admin', 0, 2, 'L');
...
$pdf->Output("DataAdmin - Oryza - ".$tgl.".pdf","D");
// $pdf->Output();
?>
